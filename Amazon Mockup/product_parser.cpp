...
{
    string myline;
    myline = category; // to shut up the compiler warnings
    getline(is, myline);
...
Product* ProductBookParser::makeProduct()
{
    ...
    Product* newBook = new Book(category_, prodName_, price_, qty_, isbn_, author_);
    return newBook;
}
...
{
    string category_ = categoryID();
    Product* newClothing = new Clothing(category_, prodName_, price_, qty_, size_, brand_);
    return newClothing;
}
...
{
    string category_ = categoryID();
    Product* newMovie = new Movie(category_, prodName_, price_, qty_, genre_, rating_);
    return newMovie;
}
